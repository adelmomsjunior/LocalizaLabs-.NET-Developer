...
namespace Vaquinha.Unit.Tests.DomainTests
{
    ...
    public class CartaoCreditoTests: IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact]
        [Trait("CartaoCredito", "CartaoCredito_CorretamentePreenchido_CartaoCreditoValidadeExpirada")]
        public void CartaoCredito_CorretamentePreenchido_CartaoCreditoValidadeExpirada()
        {
            // Arrange
